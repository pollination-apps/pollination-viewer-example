# pollination-viewer-example

Example showing advanced usage of the pollination viewer.
...
```
> pollination-apps run app ladybug-tools --name "pollination-viewer-example"
```

## Deploy to Pollination

```
> pollination-apps deploy app --name "pollination-viewer-example" --public --api-token "Your api token from Pollination"
```
...
Github actions will then package and deploy your code to an app called [pollination-viewer-example](https://app.pollination.cloud/ladybug-tools/applications/pollination-viewer-example)
